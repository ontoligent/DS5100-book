...
This will open a window in RStudio with the following content:

![](images/tibbles-vignette.png){style="border: 1px solid gray;" width="506"}
...
![](images/view-tibble.png){style="border: 1px solid gray;"}
