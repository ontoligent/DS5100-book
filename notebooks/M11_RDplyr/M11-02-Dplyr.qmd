...
It is an optimized and distilled version of his previous `plyr` package, which was an attempt to organize much of the functionality of the `*apply` family of functions in base R.
Although in many ways superseded the `plyr` and `dplyr`, [these older functions remain useful](https://stackoverflow.com/questions/3505701/grouping-functions-tapply-by-aggregate-and-the-apply-family).
