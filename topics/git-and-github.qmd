...
4.  **GitHub** (and services like it) builds on top of Git, **adding some functionality** to it, while Git can interact with GitHub through actions like cloning, pushing, and pulling. However,
